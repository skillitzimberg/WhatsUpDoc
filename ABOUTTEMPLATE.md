...
```
dotnet new --install [ /Users/Your/Path/Here ]/WhatsUpDoc
```
...
```
dotnet new --install /Users/Guest/Desktop/WhatsUpDoc
```
...
```
dotnet new WhatsUpDoc -n [ YourProjectName ]
```
For example: If your project is called Banana the command would be:
```
dotnet new WhatsUpDoc -n Banana
```
